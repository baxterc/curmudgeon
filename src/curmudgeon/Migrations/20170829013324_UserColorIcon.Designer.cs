...
namespace curmudgeon.Migrations
{
    ...
    [Migration("20170829013324_UserColorIcon")]
    partial class UserColorIcon
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("curmudgeon.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("curmudgeon.Models.Post", b =>
                {
            ...
            modelBuilder.Entity("curmudgeon.Models.PostTag", b =>
                {
            ...
            modelBuilder.Entity("curmudgeon.Models.Tag", b =>
                {
                    b.Property<int>("TagId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("curmudgeon.Models.Post", b =>
                {
                    b.HasOne("curmudgeon.Models.ApplicationUser", "Account")
                        .WithMany("UserPosts")
            ...
            modelBuilder.Entity("curmudgeon.Models.PostTag", b =>
                {
                    b.HasOne("curmudgeon.Models.Post", "Post")
                        .WithMany("PostTags")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("curmudgeon.Models.ApplicationUser")
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
